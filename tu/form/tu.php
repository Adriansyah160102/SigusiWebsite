...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
        ...
        <main class="content">
            ...
            <form class="biodata" name='frm' action='../m_/m_tu.php?ak=<?php echo $ak; ?>' method='post' >
		        <div class="form">
			        <label>Id Tata Usaha</label>
			        <input type="text" name="id_tatausaha" required=required value="<?php  echo $id; ?> " readonly=readonly/> </br>
                </div>
		        <div class="form">
		            <label>Nama</label>
		        ...
		        <div class="form">
			        ...
			        <input type="text" placeholder='username' name="username" required=required value="<?php  echo $user; ?>" /> </br>
                </div>
		        <div class="form">
			        <label>Password</label>
			        <input type="text" placeholder='password' name="password" required=required value="<?php  echo $pass; ?>" /> </br>
                </div>
		        <div class="form">

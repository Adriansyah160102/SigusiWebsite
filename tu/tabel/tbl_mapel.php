	...
	if(mysqli_num_rows($cari)==0)
		...
		while ($tampil = mysqli_fetch_assoc($cari))
			{ echo "<tr class='satu'>
			  			...
			  			";
?>
						<a href='#' onclick="konfir_hapus('<?php echo "../m_/m_mapel.php?ak=hapus&id_mapel=".$tampil['id_mapel']; ?>','<?php echo $tampil['nama_mapel']; ?>')"><img src='../icon/delete.png' width='30' height='30' align='center'/></a>
			  		<?php
			  		echo "
			  		</td>
			  		</tr>"; 

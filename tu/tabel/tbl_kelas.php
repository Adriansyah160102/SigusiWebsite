...
<a href="../form/kelas.php"><button><img src="../icon/addclass.png" width="30" height="30"/></button></a></br></br>
    <table class="table">
            <thead>
                <th>NO</th>
                <th>ID Kelas</th>
		...
		while ($tampil = mysqli_fetch_assoc($cari))
			{ echo "<tr class='satu'>
			  			...
			  			<td >".$tampil['kelas']."</td>
			  			<td ><a href='../form/kelas.php?form=kelas&act=edit&id_kelas=".$tampil['id_kelas']."&kelas=".$tampil['kelas']."'><img src='../icon/edit.png' width='30' height='30' align='center'/></a> 
			  			";
?>
			  			<a href ='#'onclick="konfir_hapus('<?php echo "../m_/m_kelas.php?ak=hapus&id_kelas=".$tampil['id_kelas']; ?>','<?php echo $tampil['kelas']; ?>')"><img src='../icon/delete.png' width='30' height='30' align='center'/></a>
			  			<?php
			  			echo "
			  			</td>
			  		</tr>"; 

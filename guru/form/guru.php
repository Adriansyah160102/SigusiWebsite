...
<html lang="en">
    ...
    <body>
        ...
        <main class="content">
            ...
            <form class="biodata" name="frm" action="../m_/m_guru.php?ak=<?php echo $ak; ?>" method="POST">
		        <div class="form">
			        <label>Id Guru</label>
		        ...
		        <div class="form">
			        <label>Nama</label>
			        <input type="text" name="nama_guru" required=required value="<?php echo $nm; ?>"></br>
                </div>
		        <div class="form">

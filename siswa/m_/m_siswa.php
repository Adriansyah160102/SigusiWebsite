...
{
	mysqli_query($con,"insert into siswa values('$nis','$nm','$nik','$tmp_lhr','$tgl_lhr','$jenis_k',
		'$status_k','$anak_k','$jml_sdr','$agm','$hobi','$cita','$alm','$kls','$thn_ajaran','$no_tlp','$nm_ayah','$nik_ayah','$pdkn_ayah','$pkrjn_ayah','$nm_ibu','$nik_ibu','$pdkn_ibu','$pkrjn_ibu','$alm_ortu','$no_telp_ortu','$user','$pass')") or die ('Gagal Input Data!!!');
}

    ...
    <body>
        ...
        <main class="content">
            ...
            <form class="biodata" name="frm" action="../m_/m_siswa.php?ak=<?php echo $ak; ?>" method="POST">
		        <div class="form">
			        <label>NIS</label>
			        <input type="text" placeholder="No Induk Siswa" name="nis" value="<?php echo "$nis"; ?>" /></br>
                </div>
		        <div class="form">
			        <label>Nama</label>
                ...
                <div class="form">
			        ...
			        <input placeholder="pekerjaan ayah"  type="text" name="pekerjaan_ibu" value="<?php echo "$pkrjn_ibu"; ?>"></br>
                </div>
                <div class="form">
